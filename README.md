...
*1. Цель разработки* - компонентный шаблонный язык (DSL) с типизированными пропсами;
...
Посмотреть пример шаблона [тут](example.tig "Открыть пример")
...
| ------------------ | ---------------------------- | ------------- |
| Identifier         | `setup`, `template`          | Базовое слово |
